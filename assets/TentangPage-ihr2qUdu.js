import{configurePageContainer as i,setSidebarContent as t,buildPhaseOneSidebarItems as s,setPageTitle as r,toAppHref as l}from"./pageHelpers-BpmCgv2g.js";const o="v1.0.0",d="Pancasila &amp; UUD 1945",c="https://www.mkri.id/",a={koreksi:"#",saran:"#"};class f{constructor(e,{sidebarEl:n}){this.container=e,this.sidebarEl=n}mount(){i(this.container),t(this.sidebarEl,{title:"Navigasi Hukum",subtitle:"Pancasila & UUD 1945",items:s("/tentang")}),r("Tentang Aplikasi"),this.container.innerHTML=b()}}function b(){return`
